(() => {
  ...
  window.renderIsabellaCatalog = (portfolio, helpers) => {
    ...
    const products = (portfolio.projects || []).filter(item => item.is_visible !== false && (!item.item_type || item.item_type === 'product'));
    ...
    root.innerHTML = `
      <div class="ihd-page">
        <header class="ihd-header" id="inicio">
          <a class="ihd-brand" href="#inicio" aria-label="Isabella Hogar y Deco, inicio">
            <span class="ihd-mark" aria-hidden="true"><i></i><b>i</b></span>
            <span><strong>Isabella</strong><small>Hogar & Deco</small></span>
          </a>
        ...
        <footer class="ihd-footer"><div class="ihd-brand ihd-brand-footer"><span class="ihd-mark" aria-hidden="true"><i></i><b>i</b></span><span><strong>Isabella</strong><small>Hogar & Deco</small></span></div><div><p>Velas, aromas y detalles con amor.</p><small>Tolhuin · Tierra del Fuego · Argentina</small></div><div class="ihd-footer-links"><a href="${esc(instagram)}" target="_blank" rel="noopener">Instagram</a><a href="${esc(genericWa)}" target="_blank" rel="noopener">WhatsApp</a></div></footer>
        ...
        <div class="ihd-modal" id="ihdProductModal" hidden><button class="ihd-modal-backdrop" type="button" data-modal-close aria-label="Cerrar"></button><section role="dialog" aria-modal="true" aria-labelledby="ihdModalTitle"><button class="ihd-modal-close" type="button" data-modal-close aria-label="Cerrar">×</button><div class="ihd-modal-gallery" id="ihdModalGallery"></div><div class="ihd-modal-copy"><p class="ihd-eyebrow" id="ihdModalCategory"></p><h2 id="ihdModalTitle"></h2><p id="ihdModalDescription"></p><div class="ihd-modal-meta"><strong id="ihdModalPrice"></strong><span id="ihdModalAvailability"></span></div><a class="ihd-btn ihd-btn-dark" id="ihdModalContact" target="_blank" rel="noopener">Consultar este producto</a></div></section></div>
      </div>`;
    ...
    function availability(value){return ({available:'Disponible',last_units:'Últimas unidades',coming_soon:'Próximamente',sold_out:'Agotado'}[value] || 'Disponible');}
    ...
    function setupProducts(){
      const modal=root.querySelector('#ihdProductModal'),cards=[...root.querySelectorAll('[data-product-index]')];
